...
filename = 'BDI_F_SMOTE.csv'
dep = 'BDI_F'
features = read.csv("RobustFeatures.csv")$feature
for (indep in features) {
  univariate_lr(filename,dep,indep)
}
...
dep="BDI_F"
f_names = c("BDI_F_SMOTE_top10.csv","BDI_F_SMOTE_top20.csv")
for (f_name in f_names) {
  multivariate_logistic_regression(f_name, dep, TRUE, "AIC")
}
```
...
#Helper function to plot the gender-specific graphs nicely
  plotting_gender_graph <- function(sex, gender_graph, sz_sex, width_sex, coords) {
        ...
        if (sex == "Female"){colors_vec = c("green", "yellow", "red")}else {colors_vec = c("black", "purple", "blue")}
...
f_name = "ANOVAfull.csv"
indeps <- list('CLOCK3111_TCZBTB20_AB')

dep = "SPAQ"
alpha = 0.05

for (indep in indeps) {
  oneWayANOVA(f_name, indep, dep, alpha)
}

for (indep in indeps) {
  vars <- list(indep, "GENDER")
  twoWayANOVA(f_name, vars, dep, alpha)
}
```
...
create_bargraph("PER3A", "CRY1", "CC", "GG", "SPAQ")
create_bargraph("PER2", "CRY1", "AA", "GG", "SPAQ")
create_bargraph("PER2", "PER3C", "AA", "TT", "SPAQ")
create_bargraph("VNTR", "CRY1", "55", "GG", "SPAQ")
create_bargraph("VNTR", "PER3A", "45", "CC", "SPAQ")
create_bargraph("CRY2", "PER3B", "AG", "AG", "SPAQ")
create_bargraph("CRY2", "PER3C", "AA", "TG", "SPAQ")
# create_bargraph("CRY2", "PER3A", "AA", "CC", "SPAQ")
# create_bargraph("VNTR", "CRY1", "44", "GG", "SPAQ")
```
