...
def main():
    ...
    fselect=['AllFeatures', 'infogain_#', 'reliefF_#', 'jmi_#', 'mrmr_#', 'chisquare_#' 'cfs', 'fcbf'] # replace the # with the number of features you want
    ...
    #Specify which data file type you are using
